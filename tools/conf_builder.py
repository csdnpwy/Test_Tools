...
def conf_builder(args, log_path):
    ...
    vdevs = {
        '虚拟设备1（10.54.57.204|208|209）': vDev204,
        '虚拟设备2（10.54.57.206|207|213）': vDev206,
        '虚拟设备3（10.54.57.210|211|212）': vDev210,
        '虚拟设备4（10.54.57.214|215|217）': vDev214,
        '虚拟设备5（10.54.57.216|218|219）': vDev216
    }
    vdev = args.虚拟设备
    if vdev in vdevs:
